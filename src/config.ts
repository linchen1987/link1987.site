...
export const Site = 'https://link1987.site';
export const SiteLanguage = 'zh';
export const SiteTitle = 'Link1987';
export const SiteDescription = '因上努力，果上随缘';
export const FooterDescription = '因上努力，果上随缘';
export const AdminName = 'link';
export const PageSize = 15;

// socialPlatform => userName
// check components/Header.astro socialConfig for more info
export const Socials: Record<string, Record<string, string>> = {
	mail: { url: 'mailto:link.lin.1987@gmail.com' },
	github: { url: 'https://github.com/linchen1987' },
	x: { url: 'https://x.com/linklin1987' },
